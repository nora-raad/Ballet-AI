...
jsons_root = r'./training_data_json1'  # Folders like first/, second/
output_csv = 'ballet_features1_1.csv'
...
def extract_features_from_video(json_files):
    ...
    for json_file in sorted(json_files):
        ...
        # Get points
        points = {name: get_point(merged_kps, idx, 0.5) for name, idx in BODY_25_INDICES.items()}

        # Filter: Require key legs
